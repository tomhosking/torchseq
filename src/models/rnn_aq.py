...
from datasets.loaders import PAD_ID, OOV_ID
...
class RnnAqModel(nn.Module):
    def __init__(self, config, embeddings_init=None):
        ...
        self.context_encoder = nn.LSTM(
            input_size=config.embedding_dim+3,
            hidden_size=512,
            num_layers=1,
            batch_first=True,
        )
    ...
    def forward(self, batch):
        ...
        context_encoding, _ = self.context_encoder(context_augmented_packed, self.init_hidden_ctxt_encoder(curr_batch_size))
