...
class JsonDataLoader:
    def __init__(self, config):
        ...
        valid = JsonDataset(
            os.path.join(config.env.data_path, self.config.json_dataset.path), config=config, dev=True, test=False
        )
        test = JsonDataset(
            os.path.join(config.env.data_path, self.config.json_dataset.path), config=config, dev=False, test=True
        )
